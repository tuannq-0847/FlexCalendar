package com.karleinstein.smoothcalendar.listener
...
abstract class OnSwipeListener : GestureDetector.SimpleOnGestureListener() {
    ...
    override fun onFling(
        ...
        //  D => it's a LEFT swipe
        //
        val x1 = e1?.x ?: return super.onFling(e1, e2, velocityX, velocityY)
        val y1 = e1.y
        val x2 = e2?.x ?: return super.onFling(e1, e2, velocityX, velocityY)
        val y2 = e2.y
